...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210521_7bd482126b32c2b99814_20210521124754_archive.zip';
	const ARCHIVE_SIZE		 = '46282543';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7bd4821-21124754';
    const SECONDARY_PACKAGE_HASH = '0b8f515-21124754';
	const VERSION			 = '1.4.0';
